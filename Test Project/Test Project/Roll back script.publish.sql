...
GO
/*
The column [dbo].[DBVersion].[tmpColumn] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[DBVersion])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering [dbo].[DBVersion]...';


--- ------------ --------------- ----------- ------------ -----------  Change here
GO
ALTER TABLE [dbo].[DBVersion] DROP COLUMN [tmpColumn];
